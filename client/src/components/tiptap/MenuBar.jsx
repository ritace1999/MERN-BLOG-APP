...
const MenuBar = ({ editor }) => {
  ...
  return (
    <div className="border-b-2 border-dark-soft rounded-t-lg p-5 sticky top-3 items-center justify-center bg-white z-10 flex gap-0.5 flex-wrap">
      ...
      <button onClick={addImage} className={`editor-btn`}> <PiImageSquareBold />
      </button>
      <button
